...
const MainCategories= () => {
    return(
    <div className={`hidden md:flex bg-white rounden-3xl xl:rounded-full p-4 shadow-lg items-center justify-center gap-8`}>
        {/* Links */}
        <div className={`flex-1  items-center justify-between flex-wrap`}>
            ...
            <Link to="/posts?cat=search-engine" className={`hover:bg-blue-50 rounded-full px-4 py-2`}>
                Search Engine
            </Link>
